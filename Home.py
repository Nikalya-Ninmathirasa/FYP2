...
# page heading
st.markdown('<p style="font-size:40px; color:dark gray; text-align:center;">Understand the Galle Tourism Market with Guide_Bot</p> <br><br><br>', unsafe_allow_html=True)
